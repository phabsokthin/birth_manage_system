...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('birth__certificates', function (Blueprint $table) {
            ...
            $table->string('birth_note')->nullable();
            ...
            // leving baby
            $table->string('stay_province')->nullable();
            $table->string('stay_district')->nullable();
            $table->string('stay_commune')->nullable();
            $table->string('stay_village')->nullable();
            $table->string('stay_country')->nullable();
