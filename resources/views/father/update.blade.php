...
@section('content')
    ...
    <div class="content-wrapper p-4">
        ...
        <form action="{{ route('update_father.father', $father->father_id) }}" method="POST" enctype="multipart/form-data" class="mt-4">
            @csrf
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">កែប្រែព័ត៌មានរបស់ឪពុក</legend>
                ...
                <div class="control-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="{{ $father->fname_kh }}" required
                                placeholder="នាមត្រកូល(ខ្មែរ)" name="fname_kh">
                        </div>
                        <div class="col-md-3">
                            <label for="">កិត្តិនាម(ខ្មែរ): *</label>
                            <input type="text" class="form-control" value="{{ $father->lname_kh }}" required
                                placeholder="កិត្តិនាម(ខ្មែរ)" name="lname_kh">
                        </div>
                        <div class="col-md-3">
                            <label for="">នាមត្រកូល(ឡាតាំង): *</label>
                            <input type="text" class="form-control" value="{{ $father->fname_en }}" required
                                placeholder="នាមត្រកូល(ឡាតាំង)" name="fname_en">
                        </div>
                        <div class="col-md-3">
                            <label for="">កិត្តិនាម(ឡាតាំង): *</label>
                            <input type="text" class="form-control" value="{{ $father->lname_en }}" required
                                placeholder="កិត្តិនាម(ឡាតាំង)" name="lname_en">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-3">
                            ...
                            <select name="gender" required class="form-control" id="">
                                <option value="{{ $father->gender }}">{{ $father->gender }}</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="{{ $father->phones }}" required
                                placeholder="លេខទូរស័ព្ទ" name="phones">
                        </div>
                        <div class="col-md-3">
                            <label for="">សញ្ជាត្តិ</label>
                            <input type="text" class="form-control" value="{{ $father->nationality }}"
                                placeholder="សញ្ជាត្តិ" name="national">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="mt-2">
                                <p>រូបថតចាស់</p>
                                <img src="{{ asset('upload/' . $father->photo) }}" width="100px" alt="">
                            </div>
                            <input type="hidden" value="{{ $father->photo }}" name="photo">
                        </div>

                        <div class="col-md-3">
                            <label for="">ស្ថានភាពបច្ចុប្បន្ន</label>
                            <select name="fstatus" required class="form-control">
                                <option value="1" {{ $father->fstatus == 1 ? 'selected' : '' }}>នៅរស់</option>
                                <option value="0" {{ $father->fstatus == 0 ? 'selected' : '' }}>ស្លាប់</option>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <select name="day" required id="day" class="form-control">
                            <option value="{{ $father->day }}">{{ $father->day }}</option>
                        </select>
                        {{-- <input type="text" name="day" value="{{ $father->day }}"> --}}
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="search-dropdown" style="margin-top: 0px; margin-left:0px;">
                            ...
                            <div>
                                <div class="form-control" id="dropdownDisplayMonth">{{ $father->month }}</div>
                        ...
                        <input type="hidden" required name="selected_month" value="{{ $father->month }}" id="selectedMonth" value="">
                        {{-- <input type="text" value="{{ $father->month }}" name="selected_month"> --}}
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="search-dropdown" style="margin-top: 0px; margin-left: 0px;">
                            ...
                            <div>
                                <div class="form-control" id="dropdownDisplayYear">{{ $father->year }}</div>
                        ...
                        {{-- For backend --}}
                        <input type="hidden" name="selected_year" value="{{ $father->year }}"  id="selectedYear" value="">
                        {{-- <input type="text" value="{{ $father->year }}" name="selected_year"> --}}

                    </div>

                    <div class="col-md-4">
                        <label for="">មុខរបរ</label>
                        <textarea class="form-control" placeholder="មុខរបរ"  name="job_title">{{ $father->job_title }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="province" id="province-select" required class="form-control">
                            <option value="{{ $father->province_id }}">{{ $father->province_kh_name }}</option>
\                            @foreach ($province as $pro)
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_district"  value="{{ $father->dis_id }}"  id="selectedDistrict" value="">
                        {{-- <input type="text" value="{{ $father->dis_id }}" name="selected_district"> --}}
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_commune" value="{{ $father->commune_id }}" id="selectedCommune" value="">
                        {{-- <input type="text" value="{{ $father->commune_id }}" name="selected_commune"> --}}
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_village"  value="{{ $father->village_id }}"  id="selectedVillage" value="">
                        {{-- <input type="text" value="{{ $father->village_id }}" name="selected_village"> --}}
                ...
                <div class="d-flex justify-content-end mt-2">
                    <a href="{{ route('tab.father') }}" class="btn btn-danger mr-2">ត្រលប់ក្រោយ</a>
                    <button type="submit" class="btn btn-primary" id="saveButton">កែប្រែ</button>
                    <button type="button" class="btn btn-primary" id="savingButton" style="display: none;"
                        disabled>កំពុងកែប្រែ...</button>
