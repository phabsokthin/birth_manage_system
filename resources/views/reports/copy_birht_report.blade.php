    ...
    <div class="content-wrapper p-3">
        <div class="bg-white shadow-md p-3">
            <h5>
                ...
                របាយការណ៍សេចក្តីចម្លង់សំបុត្រកំណើត
            </h5>
        </div>
        ...
        <div class=" shadow-md bg-white mt-3 p-3 ">
            <div class="row">
                <div class="col-md-9">
                    <form action="{{ route('report_copy_brith.report') }}" method="GET">
                        <div class="row ">
                            <div class="col-md-3">
                ...
                <tbody>
                    @foreach ($query_copy_birth as $b)
                        <tr style="{{ $b->bstatus == 1 ? 'background-color: rgba(220, 53, 69, 0.6); color: white;' : '' }}">
                            ...
                            <td>{{ $b->copy_no }} </td>
                            <td>{{$b->copy_note}}</td>
                            <td align="center">{{ $b->day_note }}-{{ $b->month_note }}-{{ $b->year_note }}</td>
                            ...
                            <td>
                                ...
                                <a href="{{ route('print.copy_birth_certificate', $b->copy_id) }}"
                                ...
                                <a href="{{ route('get_Copy_birth.birthCertificate', $b->copy_id) }}"
                                    class="btn btn-primary btn-xs">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button class="btn btn-danger btn-xs" data-toggle="modal"
                                    data-target="#delete{{ $b->copy_id }}">
                            ...
                            <!-- delete -->
                            <div class="modal fade" id="delete{{ $b->copy_id }}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('delete.birthCertificate', $b->copy_id) }}"
