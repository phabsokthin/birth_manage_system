...
@section('content')
    ...
    <div class="content-wrapper p-4">
        <div class="d-flex gap-2 my-3">
            ...
            <h5 class="ml-1">សេចក្តីចម្លងសំបុត្របញ្ជាក់កំណើត</h5>
        </div>
        <div style="background-color: white; border-top:2px solid blue;" class="p-3">
            ...
            <div class="tab">
                ...
                <button class="tablinks" onclick="openCity(event, 'list')"><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <path d="M8 11h.01" />
                        <path d="M8 16h.01" />
                    </svg> បញ្ជីគ្រប់គ្រងសេចក្តីចម្លងសំបុត្របញ្ជាក់កំណើត</button>
                ...
                <button class="tablinks">
                    <a href="{{ route('report_copy_brith.report') }}" onclick="openCity(event, 'other')">
            ...
            <div id="new" class="tabcontent" style="display:none;">
                @include('copybirhtcertificate.create')
            </div>

            <div id="list" class="tabcontent" style="display:none;">
                @include('copybirhtcertificate.certificateList')
            </div>
