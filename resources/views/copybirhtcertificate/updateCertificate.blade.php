...
<div class="content-wrapper p-5" style="margin-top: -24px">

    <form action="{{ route('update_copy.birth_certificate', $copybirths->copy_id) }}" method="POST" enctype="multipart/form-data" class="mt-4">
        @csrf
        <fieldset class="scheduler-border">
            <legend class="scheduler-border">កែប្រែសំបុត្របញ្ជាក់កំណើត</legend>
            ...
            <div class="control-group">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" value="{{ $copybirths->copy_no }}" required placeholder="លេខសំបុត្រកំណើត" name="copy_no">
                    </div>
                    <div class="col-md-3">
                        <label for="">ចុះលេខសំបុត្របញ្ជាក់កំណើត: *</label>
                        <input type="text" class="form-control" value="{{ $copybirths->copy_note }}" required placeholder="ចុះលេខសំបុត្របញ្ជាក់កំណើត" name="copy_note">
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <label for="">នាមត្រកូល(ខ្មែរ): *</label>
                        <input type="text" class="form-control" value="{{ $copybirths->fname_kh }}" required placeholder="នាមត្រកូល(ខ្មែរ)"
                            name="fname_kh">
                    </div>
                    <div class="col-md-3">
                        <label for="">កិត្តិនាម(ខ្មែរ): *</label>
                        <input type="text" class="form-control" value="{{ $copybirths->lname_kh }}" required placeholder="កិត្តិនាម(ខ្មែរ)"
                            name="lname_kh">
                    </div>
                    <div class="col-md-3">
                        <label for="">នាមត្រកូល(ឡាតាំង): *</label>
                        <input type="text" class="form-control" value="{{ $copybirths->fname_en }}" required placeholder="នាមត្រកូល(ឡាតាំង)"
                            name="fname_en">
                    </div>
                    <div class="col-md-3">
                        <label for="">កិត្តិនាម(ឡាតាំង): *</label>
                        <input type="text" class="form-control" value="{{ $copybirths->lname_en }}" required placeholder="កិត្តិនាម(ឡាតាំង)"
                            name="lname_en">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-3">
                        ...
                        <select name="gender" required class="form-control" id="">
                            <option value="{{ $copybirths->gender }}">{{ $copybirths->gender }}"</option>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" value="{{ $copybirths->phones }}" class="form-control" required placeholder="លេខទូរស័ព្ទ" name="phones">
                    </div>
                    <div class="col-md-3">
                        <label for="">សញ្ជាត្តិ</label>
                        <input type="text" value="{{ $copybirths->nationality }}" class="form-control" placeholder="សញ្ជាត្តិ" name="national">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mt-2">
                            <p>រូបថតចាស់</p>
                            <img src="{{ asset('upload/' . $copybirths->photo) }}" width="100px" alt="">
                        </div>
                        <input type="hidden" value="{{ $copybirths->photo }}" name="photo">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="search-dropdown" style="position: relative;">
                        ...
                        <div>
                            <div class="form-control" id="dropdownDisplayFather" style="cursor: pointer;">{{ $copybirths->fatherName_kh }} {{ $copybirths->lfatherName_kh }}</div>
                    ...
                    <input type="hidden" required name="selected_father" value="{{ $copybirths->father_id }}" id="selectedFatherID" value="">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="search-dropdown" style="position: relative;">
                        ...
                        <div>
                            <div class="form-control" id="dropdownDisplayMother" style="cursor: pointer;">
                                {{ $copybirths->fmotherName_kh }} {{ $copybirths->lmotherName_kh }}
                            </div>
                    ...
                    <input type="hidden" value="{{ $copybirths->mother_id }}" required name="selected_mother" id="selectedMotherID" value="">
                </div>
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <select name="day_note" required id="day_note" class="form-control">
                        <option value="{{$copybirths->day_note}}">{{$copybirths->day_note}}</option>
                    </select>
                </div>
                <div class="col-md-3">
                    ...
                    <div>
                        <div class="form-control" id="dropdownDisplayMonth_note">{{$copybirths->month_note}}</div>
                        ...
                        <input type="hidden" required name="selected_month_note" id="selectedMonth_note" value="{{$copybirths->month_note}}">
                    </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            <div class="form-control" id="dropdownDisplayYear_note">{{$copybirths->year_note}}</div>
                            ...
                            {{-- for display name to backend --}}
                            <input type="hidden" name="selected_year_note" id="selectedYear_note" value="{{$copybirths->year_note}}">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <select name="bstatus" class="form-control" id="">
                        <option value="">{{ $copybirths->bstatus ? '' : 'សូមជ្រើសរើស' }}</option>
                        <option value="1" {{ $copybirths->bstatus == 1 ? 'selected' : '' }}>មិនបានធ្វើ</option>
                        <option value="2" {{ $copybirths->bstatus == 2 ? 'selected' : '' }}>ធម្មតា</option>
                        <option value="3" {{ $copybirths->bstatus == 3 ? 'selected' : '' }}>បានធ្វើ</option>
                    </select>
                </div>
            </div>
            <div class="mt-3 d-flex gap-2">
            ...
            <div class="row">
                <div class="col-md-2">
                    ...
                    <select name="day" required id="day" class="form-control">
                        <option value="{{ $copybirths->day  }}">{{ $copybirths->day }}</option>
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    <div class="search-dropdown" style="margin-top: 0px; margin-left:0px;">
                        <label for="">នៅខែ: *</label>
                        <div>
                            <div class="form-control" id="dropdownDisplayMonth">{{ $copybirths->month }}</div>
                    ...
                    {{-- for display name to backend --}}
                    <input type="hidden" required name="selected_month" value="{{ $copybirths->month }}" id="selectedMonth" value="">
                </div>
                ...
                <div class="col-md-3">
                    <div class="search-dropdown" style="margin-top: 0px; margin-left: 0px;">
                        <label for="">នៅឆ្នាំ: *</label>
                        <div>
                            <div class="form-control" id="dropdownDisplayYear">{{ $copybirths->year }}</div>
                    ...
                    {{-- For backend --}}
                    <input type="hidden" name="selected_year" id="selectedYear" value="{{ $copybirths->year }}">
                </div>

                <div class="col-md-4">
                    <label for="">មុខរបរ</label>
                    <textarea class="form-control" placeholder="មុខរបរ" name="job_title">{{ $copybirths->job_title }}</textarea>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <select name="province" id="province-select" required class="form-control">
                        <option value="{{ $copybirths->province_id }}">{{ $copybirths->province_kh_name }}</option>
                ...
                <div class="col-md-3">
                    ...
                    <input type="hidden" name="selected_district" value="{{ $copybirths->dis_id }}" id="selectedDistrict" value="">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="hidden" name="selected_commune" value="{{ $copybirths->commune_id }}" id="selectedCommune" value="">
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="hidden" name="selected_village" value="{{ $copybirths->village_id }}" id="selectedVillage" value="">
                </div>
            ...
            <div class="d-flex justify-content-end mt-2">
                <a href="{{ route('copytab.birthcertificate') }}" class="btn btn-danger mr-2">ត្រលប់ក្រោយ</a>
                    ...
                    success: function(fathers) {
                        fathers.forEach(function(father) {
                            $('#dropdownListFather').append(
                                `<li data-id="${father.father_id}" class="dropdown-item">${father.fname_kh} ${father.lname_kh} || ${father.fname_en} ${father.lname_en}</li>`
                            );
                        });
                    },
                    error: function() {
        ...
        $('#dropdownListFather').on('click', 'li', function() {
            ...
            $.ajax({
                ...
                success: function(father) {
                    // Assuming `father` contains properties like name, age, occupation, etc.
                    $('#fatherDetails').html(`
                    <p>Name: ${father.fname_en}</p>
                    <p>Age: ${father.day}</p>
                    <p>Occupation: ${father.job_title}</p>
                `);
                },
                error: function() {
                    ...
                    success: function(mothers) {
                        mothers.forEach(function(mother) {
                            $('#dropdownListMother').append(
                                `<li data-id="${mother.mother_id}" class="dropdown-item">${mother.fname_kh} ${mother.lname_kh} || ${mother.fname_en} ${mother.lname_en}</li>`
                            );
                        });
                    },
                    error: function() {
        ...
        $('#dropdownListMother').on('click', 'li', function() {
            ...
            $.ajax({
                ...
                success: function(mother) {
                    // Assuming `mother` contains properties like name, age, occupation, etc.
                    $('#motherDetails').html(`
