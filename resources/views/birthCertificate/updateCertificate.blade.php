...
@extends('cdn')
    ...
    <div class="content-wrapper p-5" style="margin-top: -24px">
        ...
        <form action="{{ route('update_.birth_certificate', $births->birth_id) }}" method="POST" enctype="multipart/form-data" class="mt-4">
            @csrf
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">កែប្រែសំបុត្រកំណើត</legend>
                ...
                <div class="control-group">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text"  class="form-control" value="{{ $births->birth_no }}" required placeholder="លេខសំបុត្រកំណើត" name="birth_no">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">
                            <label for="">នាមត្រកូល(ខ្មែរ): *</label>
                            <input type="text" class="form-control"  value="{{ $births->fname_kh }}" required placeholder="នាមត្រកូល(ខ្មែរ)"
                                name="fname_kh">
                        </div>
                        <div class="col-md-3">
                            <label for="">កិត្តិនាម(ខ្មែរ): *</label>
                            <input type="text" class="form-control" value="{{ $births->lname_kh }}" required placeholder="កិត្តិនាម(ខ្មែរ)"
                                name="lname_kh">
                        </div>
                        <div class="col-md-3">
                            <label for="">នាមត្រកូល(ឡាតាំង): *</label>
                            <input type="text" class="form-control" value="{{ $births->fname_en }}" required placeholder="នាមត្រកូល(ឡាតាំង)"
                                name="fname_en">
                        </div>
                        <div class="col-md-3">
                            <label for="">កិត្តិនាម(ឡាតាំង): *</label>
                            <input type="text" class="form-control" value="{{ $births->lname_en }}" required placeholder="កិត្តិនាម(ឡាតាំង)"
                                name="lname_en">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-3">
                            ...
                            <select name="gender" required class="form-control" id="">
                                <option value="{{ $births->gender }}">{{ $births->gender }}"</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" value="{{ $births->phones }}" class="form-control" required placeholder="លេខទូរស័ព្ទ" name="phones">
                        </div>
                        <div class="col-md-3">
                            <label for="">សញ្ជាត្តិ</label>
                            <input type="text" value="{{ $births->nationality }}" class="form-control" placeholder="សញ្ជាត្តិ" name="national">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="mt-2">
                                <p>រូបថតចាស់</p>
                                <img src="{{ asset('upload/' . $births->photo) }}" width="100px" alt="">
                            </div>
                            <input type="hidden" value="{{ $births->photo }}" name="photo">
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="bstatus" class="form-control" id="">
                                    <option value="">{{ $births->bstatus ? '' : 'សូមជ្រើសរើស' }}</option>
                                    <option value="1" {{ $births->bstatus == 1 ? 'selected' : '' }}>មិនបានធ្វើ</option>
                                    <option value="2" {{ $births->bstatus == 2 ? 'selected' : '' }}>ធម្មតា</option>
                                    <option value="3" {{ $births->bstatus == 3 ? 'selected' : '' }}>បានធ្វើ</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="search-dropdown" style="position: relative;">
                            ...
                            <div>
                                <div class="form-control" id="dropdownDisplayFather" style="cursor: pointer;">{{ $births->fatherName_kh }} {{ $births->lfatherName_kh }}</div>
                        ...
                        <input type="hidden" required name="selected_father" value="{{ $births->father_id }}" id="selectedFatherID" value="">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="search-dropdown" style="position: relative;">
                            ...
                            <div>
                                <div class="form-control" id="dropdownDisplayMother" style="cursor: pointer;">
                                    {{ $births->fmotherName_kh }}  {{ $births->lmotherName_kh }}
                                </div>
                        ...
                        <input type="hidden" value="{{ $births->mother_id }}" required name="selected_mother" id="selectedMotherID" value="">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        <select name="day" required id="day" class="form-control">
                            <option value="{{ $births->day  }}">{{ $births->day }}</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="search-dropdown" style="margin-top: 0px; margin-left:0px;">
                            ...
                            <div>
                                <div class="form-control" id="dropdownDisplayMonth">{{ $births->month }}</div>
                        ...
                        <input type="hidden" required name="selected_month" value="{{ $births->month }}" id="selectedMonth" value="">
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="search-dropdown" style="margin-top: 0px; margin-left: 0px;">
                            ...
                            <div>
                                <div class="form-control" id="dropdownDisplayYear">{{ $births->year }}</div>
                        ...
                        {{-- For backend --}}
                        <input type="hidden" name="selected_year" id="selectedYear" value="{{ $births->year }}">
                    </div>

                    <div class="col-md-4">
                        <label for="">មុខរបរ</label>
                        <textarea class="form-control"  placeholder="មុខរបរ" name="job_title">{{ $births->job_title }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="province" id="province-select" required class="form-control">
                            <option value="{{ $births->province_id }}">{{ $births->province_kh_name }}</option>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_district" value="{{ $births->dis_id }}" id="selectedDistrict" value="">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_commune" value="{{ $births->commune_id }}" id="selectedCommune" value="">
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_village" value="{{ $births->village_id }}" id="selectedVillage" value="">
                    </div>
                ...
                <div class="d-flex justify-content-end mt-2">
                    <a href="{{ route('tab.birthcertificate') }}" class="btn btn-danger mr-2">ត្រលប់ក្រោយ</a>
