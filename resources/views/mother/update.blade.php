...
@section('content')
    ...
    <div class="content-wrapper p-4">
        ...
        <form action="{{ route('update_mother.mother', $mother->mother_id) }}" method="POST" enctype="multipart/form-data" class="mt-4">
            @csrf
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">កែប្រែព័ត៌មានរបស់ម្តយ</legend>
                ...
                <div class="control-group">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="{{ $mother->fname_kh }}" required
                                placeholder="នាមត្រកូល(ខ្មែរ)" name="fname_kh">
                        </div>
                        <div class="col-md-3">
                            <label for="">កិត្តិនាម(ខ្មែរ): *</label>
                            <input type="text" class="form-control" value="{{ $mother->lname_kh }}" required
                                placeholder="កិត្តិនាម(ខ្មែរ)" name="lname_kh">
                        </div>
                        <div class="col-md-3">
                            <label for="">នាមត្រកូល(ឡាតាំង): *</label>
                            <input type="text" class="form-control" value="{{ $mother->fname_en }}" required
                                placeholder="នាមត្រកូល(ឡាតាំង)" name="fname_en">
                        </div>
                        <div class="col-md-3">
                            <label for="">កិត្តិនាម(ឡាតាំង): *</label>
                            <input type="text" class="form-control" value="{{ $mother->lname_en }}" required
                    ...
                    <div class="row mt-3">
                        <div class="col-md-3">
                            ...
                            <select name="gender" required class="form-control" id="">
                                <option value="{{ $mother->gender }}">{{ $mother->gender }}</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" value="{{ $mother->phones }}" required
                                placeholder="លេខទូរស័ព្ទ" name="phones">
                        </div>
                        <div class="col-md-3">
                            <label for="">សញ្ជាត្តិ</label>
                            <input type="text" class="form-control" value="{{ $mother->nationality }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="mt-2">
                                <p>រូបថតចាស់</p>
                                <img src="{{ asset('upload/' . $mother->photo) }}" width="100px" alt="">
                            </div>
                            <input type="hidden" value="{{ $mother->photo }}" name="photo">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="mstatus" required class="form-control">
                                <option value="1" {{ $mother->mstatus == 1 ? 'selected' : '' }}>នៅរស់</option>
                                <option value="0" {{ $mother->mstatus == 0 ? 'selected' : '' }}>ស្លាប់</option>
                            </select>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-2">
                        ...
                        {{-- <input type="text" name="day" value="{{ $mother->day }}"> --}}
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="search-dropdown" style="margin-top: 0px; margin-left:0px;">
                            ...
                            <div>
                                <div class="form-control" id="dropdownDisplayMonth">{{ $mother->month }}</div>
                        ...
                        <input type="hidden" required name="selected_month" value="{{ $mother->month }}" id="selectedMonth" value="">
                        {{-- <input type="text" value="{{ $mother->month }}" name="selected_month"> --}}
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="search-dropdown" style="margin-top: 0px; margin-left: 0px;">
                            ...
                            <div>
                                <div class="form-control" id="dropdownDisplayYear">{{ $mother->year }}</div>
                        ...
                        {{-- For backend --}}
                        <input type="hidden" name="selected_year" value="{{ $mother->year }}"  id="selectedYear" value="">
                        {{-- <input type="text" value="{{ $mother->year }}" name="selected_year"> --}}

                    </div>

                    <div class="col-md-4">
                        <label for="">មុខរបរ</label>
                        <textarea class="form-control" placeholder="មុខរបរ"  name="job_title">{{ $mother->job_title }}</textarea>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="province" id="province-select" required class="form-control">
                            <option value="{{ $mother->province_id }}">{{ $mother->province_kh_name }}</option>
\                            @foreach ($province as $pro)
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_district"  value="{{ $mother->dis_id }}"  id="selectedDistrict" value="">
                        {{-- <input type="text" value="{{ $mother->dis_id }}" name="selected_district"> --}}
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_commune" value="{{ $mother->commune_id }}" id="selectedCommune" value="">
                        {{-- <input type="text" value="{{ $mother->commune_id }}" name="selected_commune"> --}}
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="hidden" name="selected_village"  value="{{ $mother->village_id }}"  id="selectedVillage" value="">
                        {{-- <input type="text" value="{{ $mother->village_id }}" name="selected_village"> --}}
                ...
                <div class="d-flex justify-content-end mt-2">
                    <a href="{{ route('tab.mother') }}" class="btn btn-danger mr-2">ត្រលប់ក្រោយ</a>
