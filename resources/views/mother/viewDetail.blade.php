    ...
    <div class="content-wrapper p-4 ">
        ...
        <div class="container emp-profile pl-5" style="width: 70%">
                    ...
                    <div class="col-md-12">
                        <div class="profile-head">
                            <div class="d-flex justify-content-between align-items-center">
                                <div>
                                    <h5>
                                        {{ $mother->fname_kh }} {{ $mother->lname_kh }}
                                    </h5>
                                    <h6>
                                        {{ $mother->fname_en }} {{ $mother->lname_en }}
                                    </h6>
                                </div>
                                ...
                                <div class="mr-5 mt-3">
                                    ...
                                    <img src="{{ asset('upload/' . $mother->photo) }}" width="100px" height="100px"
                        ...
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p>{{ $mother->day }}-{{ $mother->month }}-{{ $mother->year }}</p>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
            ...
            <div class="d-flex justify-content-end mr-3">
                <a href="{{ route('tab.mother') }}" class="btn btn-primary btn-sm rounded-pill mb-4">
                    < ត្រឡប់ក្រោយ</a>
            </div>
        </div>
